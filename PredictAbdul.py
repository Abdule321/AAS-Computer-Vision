...
class PlateDatasetProcessor:
    def __init__(self, dataset_folder: str):
        ...
        # Jalur output untuk ground_truth.csv akan berada di dalam folder dataset itu sendiri
...
if __name__ == "__main__":
    # Ganti jalur ini dengan direktori 'test' dataset Anda
    # Contoh: r"C:\Users\ASUS\Downloads\Mahdi\Semester_6\UAS\Plat\test"
    dataset_path = r"C:\Users\ABDUL\OneDrive\Documents\Politeknik Negeri Batam\Teknik Robotika\Semester 6\Computer Vision (RE606)\Test License Plate\Indonesian License Plate Recognition Dataset\test"  # Sesuaikan dengan lokasi dataset Anda
